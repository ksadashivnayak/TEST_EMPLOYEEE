sap.ui.define([
	...
	return Opa5.extend("com.E.Employee_List.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/E/Employee_List/localService/mockserver"], function (mockserver) {
